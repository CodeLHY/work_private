...
# TF1.2
g++ -std=c++11 tf_geoconv.cpp tf_geoconv_g.cu.o -o tf_geoconv_so.so -shared -fPIC -I /home/hongyang/anaconda3/envs/tensorflow/lib/python3.6/site-packages/tensorflow/include -I /usr/local/cuda-8.0/include -lcudart -L /usr/local/cuda-8.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
