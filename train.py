...
parser.add_argument('--resume', type = ' ', help='Whether to use normal information')
...
model_file_src = os.path.join(Base_dir, "models","geo_cnn_classification.py")
model_file_dst = os.path.join(Log_dir, "geo_cnn_classification.py")
train_file_src = os.path.join(Base_dir, "train.py")
train_file_dst = os.path.join(Log_dir, "train.py")
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            if epoch % 10 == 0:
                save_path = saver.save(sess, os.path.join(Result_dir, "model.ckpt"))
